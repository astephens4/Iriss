...
set(ARM_TC_ROOT /opt/raspi/buildtools)
set(CMAKE_C_COMPILER    arm-linux-gnueabi${FLOAT_ABI_SUFFIX}-gcc)
set(CMAKE_CXX_COMPILER  arm-linux-gnueabi${FLOAT_ABI_SUFFIX}-g++)
set(ARM_LINUX_SYSROOT /opt/raspi/buildtools CACHE PATH "ARM cross compilation system root")
...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=armv6 -fdata-sections -Wa,--noexecstack -fsigned-char -Wno-psabi")
set(CMAKE_C_FLAGS   "${CMAKE_C_FLAGS} -march=armv6 -fdata-sections -Wa,--noexecstack -fsigned-char -Wno-psabi")
