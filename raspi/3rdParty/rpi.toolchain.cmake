...
set(ARM_TOOLCHAIN arm-bcm2708hardfp-linux-gnueabi)

set(CMAKE_C_COMPILER    /opt/raspi/buildtools/bin/${ARM_TOOLCHAIN}-gcc)
set(CMAKE_CXX_COMPILER  /opt/raspi/buildtools/bin/${ARM_TOOLCHAIN}-g++)
set(ARM_LINUX_SYSROOT /opt/raspi/buildtools/${ARM_TOOLCHAIN}/sysroot CACHE PATH "ARM cross compilation system root")
